object Outdoc_F: TOutdoc_F
  Left = 460
  Top = 172
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = #1056#1072#1079#1088#1077#1096#1080#1090#1077#1083#1100#1085#1099#1081' '#1076#1086#1082#1091#1084#1077#1085#1090'.'#1044#1086#1073#1072#1074#1083#1077#1085#1080#1077
  ClientHeight = 174
  ClientWidth = 428
  Color = clBtnFace
