...
// $Rev: 34747 $
// File generated on 30.06.2015 10:44:48 from Type Library described below.

// ************************************************************************  //
// Type Lib: C:\Windows\SysWow64\MercFPrtX.ocx (1)
...
// Server Object    : TMercuryFPrtCOM
// Help String      : ��������: ���������� ������������ "��������"
// Default Interface: IMercuryFPrt10
// Def. Intf. DISP? : No
// Event   Interface: IMercuryFPrtEvents
// TypeFlags        : (1026) CanCreate Aggregatable
// *********************************************************************//
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  TMercuryFPrtCOMProperties= class;
{$ENDIF}
  TMercuryFPrtCOM = class(TOleServer)
  private
    ...
    FIntf: IMercuryFPrt10;
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
    FProps: TMercuryFPrtCOMProperties;
    function GetServerProperties: TMercuryFPrtCOMProperties;
{$ENDIF}
    function GetDefaultInterface: IMercuryFPrt10;
  protected
    procedure InitServerData; override;
    procedure InvokeEvent(DispID: TDispID; var Params: TVariantArray); override;
    function Get_EcrModel: TxMercEcrModel;
    function Get_EcrVersion: Integer;
    function Get_Generation: Integer;
    function Get_Protocol: TxMercProtocol;
    function Get_EcrStatus: Integer;
    function Get_EcrStatusMask: Integer;
    function Get_DevStatus: Integer;
    function Get_DevStatusMask: Integer;
    function Get_DocStatus: TxMercDocStatus;
    function Get_CurrentOper: TxMercOperType;
    function Get_PortNum: Integer;
    procedure Set_PortNum(Value: Integer);
    ...
    function Get_InternalTimeout: Integer;
    procedure Set_InternalTimeout(Value: Integer);
    function Get_ExternalTimeout: Integer;
    procedure Set_ExternalTimeout(Value: Integer);
    function Get_Active: WordBool;
    procedure Set_Active(Value: WordBool);
    function Get_ConnState: TxMercConnState;
    function Get_SaleSum: Currency;
    function Get_BuyingSum: Currency;
    function Get_SerialNumber: WideString;
    function Get_RegNumber: WideString;
    function Get_TaxPayerNumber: WideString;
    function Get_HeaderLine1: WideString;
    function Get_HeaderLine2: WideString;
    function Get_HeaderLine3: WideString;
    function Get_HeaderLine4: WideString;
    function Get_StartDate: TDateTime;
    function Get_EndDate: TDateTime;
    function Get_StartNumber: Integer;
    function Get_EndNumber: Integer;
    ...
    function Get_TaxName: WideString;
    function Get_TaxDate: TDateTime;
    function Get_CounterCount: Integer;
    function Get_RewritesRemain: Integer;
    function Get_DaysRemain: Integer;
    function Get_LastFiscalReport: Integer;
    function Get_LastDayClosing: Integer;
    function Get_DayDate: TDateTime;
    function Get_LastDocOper: TxMercOperType;
    function Get_LastDocNumber: Integer;
    function Get_LastRecNumber: Integer;
    function Get_LastDocType: TxMercOperType;
    function Get_LastDocSum: Currency;
    function Get_LastDocDate: TDateTime;
    function Get_RetryOperation: WordBool;
    procedure Set_RetryOperation(Value: WordBool);
    function Get_ErrCode: Integer;
    function Get_ErrCodeEx: Integer;
    function Get_ErrMessage: WideString;
    function Get_EcrHour: Integer;
    function Get_EcrMin: Integer;
    function Get_ReportHour: Integer;
    function Get_ReportMin: Integer;
    function Get_DayHour: Integer;
    function Get_DayMin: Integer;
    function Get_LastDocHour: Integer;
    function Get_LastDocMin: Integer;
    function Get_VersionNumber: Integer;
    function Get_BuildNumber: Integer;
    function Get_Version: WideString;
    procedure Set_Version(const Value: WideString);
    function Get_EcrSubVersion: Integer;
    function Get_EKLZSupported: WordBool;
    function Get_EKLZActivated: WordBool;
    function Get_EKLZOper: TxMercOperType;
    function Get_EKLZArchiving: WordBool;
    function Get_EKLZReporting: WordBool;
    function Get_EKLZDayOpened: WordBool;
    function Get_EKLZFatalError: WordBool;
    function Get_EKLZAttention: WordBool;
    function Get_LastRepNumber: Integer;
    function Get_EKLZRest: Integer;
    function Get_LastBuyingSum: Currency;
  public
    constructor Create(AOwner: TComponent); override;
    destructor  Destroy; override;
    procedure Connect; override;
    procedure ConnectTo(svrIntf: IMercuryFPrt10);
    ...
    property DefaultInterface: IMercuryFPrt10 read GetDefaultInterface;
    property EcrModel: TxMercEcrModel read Get_EcrModel;
    property EcrVersion: Integer read Get_EcrVersion;
    property Generation: Integer read Get_Generation;
    property Protocol: TxMercProtocol read Get_Protocol;
  ...
  published
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
    property Server: TMercuryFPrtCOMProperties read GetServerProperties;
{$ENDIF}
...
// *********************************************************************//
 TMercuryFPrtCOMProperties = class(TPersistent)
  private
    FServer:    TMercuryFPrtCOM;
    function    GetDefaultInterface: IMercuryFPrt10;
    constructor Create(AServer: TMercuryFPrtCOM);
  protected
    function Get_EcrModel: TxMercEcrModel;
    function Get_EcrVersion: Integer;
    function Get_Generation: Integer;
...
procedure TMercuryFPrtCOM.InitServerData;
const
  CServerData: TServerData = (
    ClassID:   '{140A3451-BB71-4DE3-87E5-E13577DEFCD1}';
    IntfIID:   '{C389388E-BCC0-4580-8673-47193431C2C3}';
...
procedure TMercuryFPrtCOM.Connect;
var
  punk: IUnknown;
begin
  if FIntf = nil then
  begin
    punk := GetServer;
    ConnectEvents(punk);
    Fintf:= punk as IMercuryFPrt10;
  end;
end;

procedure TMercuryFPrtCOM.ConnectTo(svrIntf: IMercuryFPrt10);
begin
  Disconnect;
  FIntf := svrIntf;
  ConnectEvents(FIntf);
...
procedure TMercuryFPrtCOM.DisConnect;
begin
  if Fintf <> nil then
  begin
...
function TMercuryFPrtCOM.GetDefaultInterface: IMercuryFPrt10;
begin
  if FIntf = nil then
    Connect;
...
constructor TMercuryFPrtCOM.Create(AOwner: TComponent);
begin
  inherited Create(AOwner);
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  FProps := TMercuryFPrtCOMProperties.Create(Self);
{$ENDIF}
end;

destructor TMercuryFPrtCOM.Destroy;
begin
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  FProps.Free;
{$ENDIF}
...
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
function TMercuryFPrtCOM.GetServerProperties: TMercuryFPrtCOMProperties;
begin
  Result := FProps;
end;
{$ENDIF}

procedure TMercuryFPrtCOM.InvokeEvent(DispID: TDispID; var Params: TVariantArray);
begin
  case DispID of
    -1: Exit;  // DISPID_UNKNOWN
    201: if Assigned(FOnNoResponse) then
         FOnNoResponse(Self);
    204: if Assigned(FOnStatusUpdate) then
         FOnStatusUpdate(Self);
    205: if Assigned(FOnConnStateUpdate) then
         FOnConnStateUpdate(Self);
    202: if Assigned(FOnPrinterError) then
         FOnPrinterError(Self);
    203: if Assigned(FOnDisplayError) then
         FOnDisplayError(Self);
  end; {case DispID}
end;

function TMercuryFPrtCOM.Get_EcrModel: TxMercEcrModel;
begin
    Result := DefaultInterface.EcrModel;
end;

function TMercuryFPrtCOM.Get_EcrVersion: Integer;
begin
    Result := DefaultInterface.EcrVersion;
end;

function TMercuryFPrtCOM.Get_Generation: Integer;
begin
    Result := DefaultInterface.Generation;
end;

function TMercuryFPrtCOM.Get_Protocol: TxMercProtocol;
begin
    Result := DefaultInterface.Protocol;
end;

function TMercuryFPrtCOM.Get_EcrStatus: Integer;
begin
    Result := DefaultInterface.EcrStatus;
end;

function TMercuryFPrtCOM.Get_EcrStatusMask: Integer;
begin
    Result := DefaultInterface.EcrStatusMask;
end;

function TMercuryFPrtCOM.Get_DevStatus: Integer;
begin
    Result := DefaultInterface.DevStatus;
end;

function TMercuryFPrtCOM.Get_DevStatusMask: Integer;
begin
    Result := DefaultInterface.DevStatusMask;
end;

function TMercuryFPrtCOM.Get_DocStatus: TxMercDocStatus;
begin
    Result := DefaultInterface.DocStatus;
end;

function TMercuryFPrtCOM.Get_CurrentOper: TxMercOperType;
begin
    Result := DefaultInterface.CurrentOper;
end;

function TMercuryFPrtCOM.Get_PortNum: Integer;
begin
    Result := DefaultInterface.PortNum;
end;

procedure TMercuryFPrtCOM.Set_PortNum(Value: Integer);
begin
  DefaultInterface.Set_PortNum(Value);
end;

function TMercuryFPrtCOM.Get_BaudRate: Integer;
begin
    Result := DefaultInterface.BaudRate;
end;

procedure TMercuryFPrtCOM.Set_BaudRate(Value: Integer);
begin
  DefaultInterface.Set_BaudRate(Value);
end;

function TMercuryFPrtCOM.Get_Password: WideString;
begin
    Result := DefaultInterface.Password;
end;

procedure TMercuryFPrtCOM.Set_Password(const Value: WideString);
...
function TMercuryFPrtCOM.Get_InternalTimeout: Integer;
begin
    Result := DefaultInterface.InternalTimeout;
end;

procedure TMercuryFPrtCOM.Set_InternalTimeout(Value: Integer);
begin
  DefaultInterface.Set_InternalTimeout(Value);
end;

function TMercuryFPrtCOM.Get_ExternalTimeout: Integer;
begin
    Result := DefaultInterface.ExternalTimeout;
end;

procedure TMercuryFPrtCOM.Set_ExternalTimeout(Value: Integer);
begin
  DefaultInterface.Set_ExternalTimeout(Value);
end;

function TMercuryFPrtCOM.Get_Active: WordBool;
begin
    Result := DefaultInterface.Active;
end;

procedure TMercuryFPrtCOM.Set_Active(Value: WordBool);
begin
  DefaultInterface.Set_Active(Value);
end;

function TMercuryFPrtCOM.Get_ConnState: TxMercConnState;
begin
    Result := DefaultInterface.ConnState;
end;

function TMercuryFPrtCOM.Get_SaleSum: Currency;
begin
    Result := DefaultInterface.SaleSum;
end;

function TMercuryFPrtCOM.Get_BuyingSum: Currency;
begin
    Result := DefaultInterface.BuyingSum;
end;

function TMercuryFPrtCOM.Get_SerialNumber: WideString;
begin
    Result := DefaultInterface.SerialNumber;
end;

function TMercuryFPrtCOM.Get_RegNumber: WideString;
begin
    Result := DefaultInterface.RegNumber;
end;

function TMercuryFPrtCOM.Get_TaxPayerNumber: WideString;
begin
    Result := DefaultInterface.TaxPayerNumber;
end;

function TMercuryFPrtCOM.Get_HeaderLine1: WideString;
begin
    Result := DefaultInterface.HeaderLine1;
end;

function TMercuryFPrtCOM.Get_HeaderLine2: WideString;
begin
    Result := DefaultInterface.HeaderLine2;
end;

function TMercuryFPrtCOM.Get_HeaderLine3: WideString;
begin
    Result := DefaultInterface.HeaderLine3;
end;

function TMercuryFPrtCOM.Get_HeaderLine4: WideString;
begin
    Result := DefaultInterface.HeaderLine4;
end;

function TMercuryFPrtCOM.Get_StartDate: TDateTime;
begin
    Result := DefaultInterface.StartDate;
end;

function TMercuryFPrtCOM.Get_EndDate: TDateTime;
begin
    Result := DefaultInterface.EndDate;
end;

function TMercuryFPrtCOM.Get_StartNumber: Integer;
begin
    Result := DefaultInterface.StartNumber;
end;

function TMercuryFPrtCOM.Get_EndNumber: Integer;
begin
    Result := DefaultInterface.EndNumber;
end;

function TMercuryFPrtCOM.Get_ReportDate: TDateTime;
begin
    Result := DefaultInterface.ReportDate;
end;

function TMercuryFPrtCOM.Get_ModelName: WideString;
begin
    Result := DefaultInterface.ModelName;
end;

function TMercuryFPrtCOM.Get_Manufacturer: WideString;
begin
    Result := DefaultInterface.Manufacturer;
end;

function TMercuryFPrtCOM.Get_FirmwareVersion: WideString;
begin
    Result := DefaultInterface.FirmwareVersion;
end;

function TMercuryFPrtCOM.Get_TaxName: WideString;
begin
    Result := DefaultInterface.TaxName;
end;

function TMercuryFPrtCOM.Get_TaxDate: TDateTime;
begin
    Result := DefaultInterface.TaxDate;
end;

function TMercuryFPrtCOM.Get_CounterCount: Integer;
begin
    Result := DefaultInterface.CounterCount;
end;

function TMercuryFPrtCOM.Get_RewritesRemain: Integer;
begin
    Result := DefaultInterface.RewritesRemain;
end;

function TMercuryFPrtCOM.Get_DaysRemain: Integer;
begin
    Result := DefaultInterface.DaysRemain;
end;

function TMercuryFPrtCOM.Get_LastFiscalReport: Integer;
begin
    Result := DefaultInterface.LastFiscalReport;
end;

function TMercuryFPrtCOM.Get_LastDayClosing: Integer;
begin
    Result := DefaultInterface.LastDayClosing;
end;

function TMercuryFPrtCOM.Get_DayDate: TDateTime;
begin
    Result := DefaultInterface.DayDate;
end;

function TMercuryFPrtCOM.Get_LastDocOper: TxMercOperType;
begin
    Result := DefaultInterface.LastDocOper;
end;

function TMercuryFPrtCOM.Get_LastDocNumber: Integer;
begin
    Result := DefaultInterface.LastDocNumber;
end;

function TMercuryFPrtCOM.Get_LastRecNumber: Integer;
begin
    Result := DefaultInterface.LastRecNumber;
end;

function TMercuryFPrtCOM.Get_LastDocType: TxMercOperType;
begin
    Result := DefaultInterface.LastDocType;
end;

function TMercuryFPrtCOM.Get_LastDocSum: Currency;
begin
    Result := DefaultInterface.LastDocSum;
end;

function TMercuryFPrtCOM.Get_LastDocDate: TDateTime;
begin
    Result := DefaultInterface.LastDocDate;
end;

function TMercuryFPrtCOM.Get_RetryOperation: WordBool;
begin
    Result := DefaultInterface.RetryOperation;
end;

procedure TMercuryFPrtCOM.Set_RetryOperation(Value: WordBool);
begin
  DefaultInterface.Set_RetryOperation(Value);
end;

function TMercuryFPrtCOM.Get_ErrCode: Integer;
begin
    Result := DefaultInterface.ErrCode;
end;

function TMercuryFPrtCOM.Get_ErrCodeEx: Integer;
begin
    Result := DefaultInterface.ErrCodeEx;
end;

function TMercuryFPrtCOM.Get_ErrMessage: WideString;
begin
    Result := DefaultInterface.ErrMessage;
end;

function TMercuryFPrtCOM.Get_EcrHour: Integer;
begin
    Result := DefaultInterface.EcrHour;
end;

function TMercuryFPrtCOM.Get_EcrMin: Integer;
begin
    Result := DefaultInterface.EcrMin;
end;

function TMercuryFPrtCOM.Get_ReportHour: Integer;
begin
    Result := DefaultInterface.ReportHour;
end;

function TMercuryFPrtCOM.Get_ReportMin: Integer;
begin
    Result := DefaultInterface.ReportMin;
end;

function TMercuryFPrtCOM.Get_DayHour: Integer;
begin
    Result := DefaultInterface.DayHour;
end;

function TMercuryFPrtCOM.Get_DayMin: Integer;
begin
    Result := DefaultInterface.DayMin;
end;

function TMercuryFPrtCOM.Get_LastDocHour: Integer;
begin
    Result := DefaultInterface.LastDocHour;
end;

function TMercuryFPrtCOM.Get_LastDocMin: Integer;
begin
    Result := DefaultInterface.LastDocMin;
end;

function TMercuryFPrtCOM.Get_VersionNumber: Integer;
begin
    Result := DefaultInterface.VersionNumber;
end;

function TMercuryFPrtCOM.Get_BuildNumber: Integer;
begin
    Result := DefaultInterface.BuildNumber;
end;

function TMercuryFPrtCOM.Get_Version: WideString;
begin
    Result := DefaultInterface.Version;
end;

procedure TMercuryFPrtCOM.Set_Version(const Value: WideString);
...
begin
  InterfaceVariant := DefaultInterface;
  InterfaceVariant.Version := Value;
end;

function TMercuryFPrtCOM.Get_EcrSubVersion: Integer;
begin
    Result := DefaultInterface.EcrSubVersion;
end;

function TMercuryFPrtCOM.Get_EKLZSupported: WordBool;
begin
    Result := DefaultInterface.EKLZSupported;
end;

function TMercuryFPrtCOM.Get_EKLZActivated: WordBool;
begin
    Result := DefaultInterface.EKLZActivated;
end;

function TMercuryFPrtCOM.Get_EKLZOper: TxMercOperType;
begin
    Result := DefaultInterface.EKLZOper;
end;

function TMercuryFPrtCOM.Get_EKLZArchiving: WordBool;
begin
    Result := DefaultInterface.EKLZArchiving;
end;

function TMercuryFPrtCOM.Get_EKLZReporting: WordBool;
begin
    Result := DefaultInterface.EKLZReporting;
end;

function TMercuryFPrtCOM.Get_EKLZDayOpened: WordBool;
begin
    Result := DefaultInterface.EKLZDayOpened;
end;

function TMercuryFPrtCOM.Get_EKLZFatalError: WordBool;
begin
    Result := DefaultInterface.EKLZFatalError;
end;

function TMercuryFPrtCOM.Get_EKLZAttention: WordBool;
begin
    Result := DefaultInterface.EKLZAttention;
end;

function TMercuryFPrtCOM.Get_LastRepNumber: Integer;
begin
    Result := DefaultInterface.LastRepNumber;
end;

function TMercuryFPrtCOM.Get_EKLZRest: Integer;
begin
    Result := DefaultInterface.EKLZRest;
end;

function TMercuryFPrtCOM.Get_LastBuyingSum: Currency;
begin
    Result := DefaultInterface.LastBuyingSum;
end;

procedure TMercuryFPrtCOM.Open;
begin
  DefaultInterface.Open;
end;

procedure TMercuryFPrtCOM.Close(ForceAbort: WordBool);
begin
  DefaultInterface.Close(ForceAbort);
end;

procedure TMercuryFPrtCOM.OpenReceipt(Oper: TxMercOperType);
begin
  DefaultInterface.OpenReceipt(Oper);
end;

procedure TMercuryFPrtCOM.AddReceiptItem(const Desc: WideString; Price: Currency; 
...
procedure TMercuryFPrtCOM.CancelReceipt;
begin
  DefaultInterface.CancelReceipt;
end;

procedure TMercuryFPrtCOM.CloseReceipt(const Account: WideString; PayType: TxMercPayType; 
...
procedure TMercuryFPrtCOM.OpenCustomDoc(UseForm: WordBool; Oper: TxMercOperType);
begin
  DefaultInterface.OpenCustomDoc(UseForm, Oper);
end;

procedure TMercuryFPrtCOM.CancelCustomDoc;
begin
  DefaultInterface.CancelCustomDoc;
end;

procedure TMercuryFPrtCOM.CloseCustomDoc(PayType: TxMercPayType; Flags: Integer; 
                                         HCopiesNum: Integer; VCopiesNum: Integer; 
                                         VOrigOffset: Integer; HCopyOffset: Integer; 
                                         VCopyOffset: Integer; FiscalCopy: Integer);
begin
...
procedure TMercuryFPrtCOM.OpenFiscalDoc(Oper: TxMercOperType);
begin
  DefaultInterface.OpenFiscalDoc(Oper);
end;

procedure TMercuryFPrtCOM.CancelFiscalDoc(BufferOnly: WordBool);
begin
  DefaultInterface.CancelFiscalDoc(BufferOnly);
end;

procedure TMercuryFPrtCOM.PrintFiscalDocBuffer;
begin
  DefaultInterface.PrintFiscalDocBuffer;
end;

procedure TMercuryFPrtCOM.CloseFiscalDoc;
begin
  DefaultInterface.CloseFiscalDoc;
end;

procedure TMercuryFPrtCOM.CopyFiscalDoc;
begin
  DefaultInterface.CopyFiscalDoc;
end;

procedure TMercuryFPrtCOM.AddSerialNumber(Flags: Integer; HOffset: Integer; VOffset: Integer);
begin
  DefaultInterface.AddSerialNumber(Flags, HOffset, VOffset);
end;

procedure TMercuryFPrtCOM.AddHeaderLine(LineNum: Integer; Flags: Integer; HOffset: Integer; 
                                        VOffset: Integer);
begin
  DefaultInterface.AddHeaderLine(LineNum, Flags, HOffset, VOffset);
end;

procedure TMercuryFPrtCOM.AddDateTime(Flags: Integer; HOffset: Integer; VOffset: Integer);
begin
  DefaultInterface.AddDateTime(Flags, HOffset, VOffset);
end;

procedure TMercuryFPrtCOM.AddOperInfo(OperInfo: TxMercOperInfo; Flags: Integer; HOffset: Integer; 
                                      VOffset: Integer);
begin
  DefaultInterface.AddOperInfo(OperInfo, Flags, HOffset, VOffset);
end;

procedure TMercuryFPrtCOM.AddDocNumber(Flags: Integer; HOffset: Integer; VOffset: Integer);
begin
  DefaultInterface.AddDocNumber(Flags, HOffset, VOffset);
end;

procedure TMercuryFPrtCOM.AddReceiptNumber(Flags: Integer; HOffset: Integer; VOffset: Integer);
begin
  DefaultInterface.AddReceiptNumber(Flags, HOffset, VOffset);
end;

procedure TMercuryFPrtCOM.AddAccount(const Account: WideString; Flags: Integer; HOffset: Integer; 
                                     VOffset: Integer);
begin
  DefaultInterface.AddAccount(Account, Flags, HOffset, VOffset);
end;

procedure TMercuryFPrtCOM.AddTaxPayerNumber(Flags: Integer; HOffset: Integer; VOffset: Integer);
begin
  DefaultInterface.AddTaxPayerNumber(Flags, HOffset, VOffset);
end;

procedure TMercuryFPrtCOM.AddItem(ItemType: TxMercItemType; Price: Currency; ItemIsTare: WordBool; 
                                  Department: Integer; Code: Integer; Adjustment: Integer; 
                                  Quantity: Integer; QuantityPrec: Integer; TaxIndex: Integer; 
...
procedure TMercuryFPrtCOM.AddDocPercentAdj(Value: Integer; TaxIndex: Integer; Flags: Integer; 
...
procedure TMercuryFPrtCOM.AddDocAmountAdj(Value: Currency; TaxIndex: Integer; Flags: Integer; 
                                          HOffset: Integer; VOffset: Integer; RightOffset: Integer);
begin
  DefaultInterface.AddDocAmountAdj(Value, TaxIndex, Flags, HOffset, VOffset, RightOffset);
end;

procedure TMercuryFPrtCOM.AddTotal(Flags: Integer; HOffset: Integer; VOffset: Integer; 
                                   RightOffset: Integer);
begin
  DefaultInterface.AddTotal(Flags, HOffset, VOffset, RightOffset);
end;

procedure TMercuryFPrtCOM.AddPay(PayType: TxMercPayType; PayCash: Currency; PayCashless: Currency; 
...
procedure TMercuryFPrtCOM.AddChange(Flags: Integer; HOffset: Integer; VOffset: Integer; 
                                    RightOffset: Integer);
begin
  DefaultInterface.AddChange(Flags, HOffset, VOffset, RightOffset);
end;

procedure TMercuryFPrtCOM.AddTaxSum(TaxIndex: Integer; Flags: Integer; HOffset: Integer; 
                                    VOffset: Integer; RightOffset: Integer);
begin
  DefaultInterface.AddTaxSum(TaxIndex, Flags, HOffset, VOffset, RightOffset);
end;

procedure TMercuryFPrtCOM.AddFiscalSign(Flags: Integer; HOffset: Integer; VOffset: Integer);
begin
  DefaultInterface.AddFiscalSign(Flags, HOffset, VOffset);
end;

procedure TMercuryFPrtCOM.AddBarcode(Mask1: Integer; Mask2: Integer; Mask3: Integer; 
                                     Mask4: Integer; Mask5: Integer; DoubleDensity: WordBool; 
                                     Flags: Integer; HOffset: Integer; VOffset: Integer);
begin
  DefaultInterface.AddBarcode(Mask1, Mask2, Mask3, Mask4, Mask5, DoubleDensity, Flags, HOffset, 
                              VOffset);
end;

procedure TMercuryFPrtCOM.AddCustom(const Text: WideString; Flags: Integer; HOffset: Integer; 
                                    VOffset: Integer);
begin
  DefaultInterface.AddCustom(Text, Flags, HOffset, VOffset);
end;

procedure TMercuryFPrtCOM.RepeatOperation;
begin
  DefaultInterface.RepeatOperation;
end;

procedure TMercuryFPrtCOM.OpenDay(OperNum: Integer; const OperName: WideString; 
                                  FullJournal: WordBool; AProtocol: TxMercProtocol);
begin
  DefaultInterface.OpenDay(OperNum, OperName, FullJournal, AProtocol);
end;

function TMercuryFPrtCOM.ZReport(Flags: Integer): Integer;
begin
  Result := DefaultInterface.ZReport(Flags);
end;

function TMercuryFPrtCOM.FiscalRewrite(const InspPswd: WideString; const RegNum: WideString; 
                                       const TaxPayerNum: WideString; const NewInspPswd: WideString): Integer;
begin
  Result := DefaultInterface.FiscalRewrite(InspPswd, RegNum, TaxPayerNum, NewInspPswd);
end;

function TMercuryFPrtCOM.FiscalReportByNum(const InspPswd: WideString; PrintFull: WordBool; 
                                           AStartNum: Integer; AEndNum: Integer): Integer;
begin
  Result := DefaultInterface.FiscalReportByNum(InspPswd, PrintFull, AStartNum, AEndNum);
end;

function TMercuryFPrtCOM.FiscalReportByDate(const InspPswd: WideString; PrintFull: WordBool; 
                                            AStartDate: TDateTime; AEndDate: TDateTime): Integer;
begin
  Result := DefaultInterface.FiscalReportByDate(InspPswd, PrintFull, AStartDate, AEndDate);
end;

function TMercuryFPrtCOM.FiscalReportAll(const InspPswd: WideString): Integer;
begin
  Result := DefaultInterface.FiscalReportAll(InspPswd);
end;

procedure TMercuryFPrtCOM.FeedAndCut(LineCount: Integer; CutAfterFeed: WordBool);
begin
  DefaultInterface.FeedAndCut(LineCount, CutAfterFeed);
end;

procedure TMercuryFPrtCOM.PrintNonFiscal(const Data: WideString; OpenDoc: WordBool; 
                                         CloseDoc: WordBool);
begin
  DefaultInterface.PrintNonFiscal(Data, OpenDoc, CloseDoc);
end;

procedure TMercuryFPrtCOM.ShowDisplay(const Data: WideString; OpenMode: WordBool; 
                                      CloseMode: WordBool);
begin
  DefaultInterface.ShowDisplay(Data, OpenMode, CloseMode);
end;

procedure TMercuryFPrtCOM.SetDisplayBaudRate(BaudRate: Integer);
begin
  DefaultInterface.SetDisplayBaudRate(BaudRate);
end;

procedure TMercuryFPrtCOM.ExternalPulse(Channel: Integer; TimeOn: Integer; TimeOff: Integer; 
                                        Count: Integer);
begin
  DefaultInterface.ExternalPulse(Channel, TimeOn, TimeOff, Count);
end;

procedure TMercuryFPrtCOM.QueryDevExStatus;
begin
  DefaultInterface.QueryDevExStatus;
end;

procedure TMercuryFPrtCOM.QueryFirmwareInfo;
begin
  DefaultInterface.QueryFirmwareInfo;
end;

procedure TMercuryFPrtCOM.SetHeader(const Line1: WideString; const Line2: WideString; 
                                    const Line3: WideString; const Line4: WideString);
begin
  DefaultInterface.SetHeader(Line1, Line2, Line3, Line4);
end;

procedure TMercuryFPrtCOM.SetTax(Index: Integer; const TaxName: WideString; TaxRate: Integer);
begin
  DefaultInterface.SetTax(Index, TaxName, TaxRate);
end;

function TMercuryFPrtCOM.QueryTax(Index: Integer): Integer;
begin
  Result := DefaultInterface.QueryTax(Index);
end;

function TMercuryFPrtCOM.QueryCounter(Index: Integer; NoRequest: WordBool): Currency;
begin
  Result := DefaultInterface.QueryCounter(Index, NoRequest);
end;

procedure TMercuryFPrtCOM.SynchronizeEcrDateTime;
begin
  DefaultInterface.SynchronizeEcrDateTime;
end;

procedure TMercuryFPrtCOM.QueryResourceInfo(PrintInfo: WordBool);
begin
  DefaultInterface.QueryResourceInfo(PrintInfo);
end;

procedure TMercuryFPrtCOM.QueryLastDocInfo;
begin
  DefaultInterface.QueryLastDocInfo;
end;

procedure TMercuryFPrtCOM.SetParameters(Protocol: TxMercProtocol; PrnTimeout: Integer);
begin
  DefaultInterface.SetParameters(Protocol, PrnTimeout);
end;

function TMercuryFPrtCOM.QueryHeaderLine(LineNum: Integer): WideString;
begin
  Result := DefaultInterface.QueryHeaderLine(LineNum);
end;

function TMercuryFPrtCOM.QuerySerialNumber: WideString;
begin
  Result := DefaultInterface.QuerySerialNumber;
end;

procedure TMercuryFPrtCOM.SetSerialNumber(const Value: WideString);
begin
  DefaultInterface.SetSerialNumber(Value);
end;

function TMercuryFPrtCOM.QueryTaxPayerNumber: WideString;
begin
  Result := DefaultInterface.QueryTaxPayerNumber;
end;

function TMercuryFPrtCOM.QueryRegNumber: WideString;
begin
  Result := DefaultInterface.QueryRegNumber;
end;

function TMercuryFPrtCOM.QueryEcrDateTime: TDateTime;
begin
  Result := DefaultInterface.QueryEcrDateTime;
end;

function TMercuryFPrtCOM.QueryDepartName(DepartNum: Integer): WideString;
begin
  Result := DefaultInterface.QueryDepartName(DepartNum);
end;

procedure TMercuryFPrtCOM.SetDepartName(DepartNum: Integer; const Value: WideString);
begin
  DefaultInterface.SetDepartName(DepartNum, Value);
end;

function TMercuryFPrtCOM.QueryTitle(TitleNum: Integer): WideString;
begin
  Result := DefaultInterface.QueryTitle(TitleNum);
end;

procedure TMercuryFPrtCOM.SetTitle(TitleNum: Integer; const Value: WideString);
begin
  DefaultInterface.SetTitle(TitleNum, Value);
end;

function TMercuryFPrtCOM.CheckEcrStatus(Flag: Integer): Integer;
begin
  Result := DefaultInterface.CheckEcrStatus(Flag);
end;

function TMercuryFPrtCOM.CheckDevStatus(Flag: Integer): Integer;
begin
  Result := DefaultInterface.CheckDevStatus(Flag);
end;

procedure TMercuryFPrtCOM.AddGraphicHeader(Flags: Integer; HOffset: Integer; VOffset: Integer);
begin
  DefaultInterface.AddGraphicHeader(Flags, HOffset, VOffset);
end;

procedure TMercuryFPrtCOM.SetProtocol(Protocol: TxMercProtocol);
begin
  DefaultInterface.SetProtocol(Protocol);
end;

procedure TMercuryFPrtCOM.SetPrinterTimeout(Timeout: Integer);
begin
  DefaultInterface.SetPrinterTimeout(Timeout);
end;

procedure TMercuryFPrtCOM.SetDisplayTimeout(Timeout: Integer);
begin
  DefaultInterface.SetDisplayTimeout(Timeout);
end;

procedure TMercuryFPrtCOM.SetPrinterContrast(Contrast: Integer);
begin
  DefaultInterface.SetPrinterContrast(Contrast);
end;

procedure TMercuryFPrtCOM.SetLeading(Leading: Integer);
begin
  DefaultInterface.SetLeading(Leading);
end;

procedure TMercuryFPrtCOM.SetCutterDisabled(Disabled: WordBool);
begin
  DefaultInterface.SetCutterDisabled(Disabled);
end;

procedure TMercuryFPrtCOM.SetNarrowPaper(Narrow: WordBool);
begin
  DefaultInterface.SetNarrowPaper(Narrow);
end;

function TMercuryFPrtCOM.QueryPrinterTimeout: Integer;
begin
  Result := DefaultInterface.QueryPrinterTimeout;
end;

function TMercuryFPrtCOM.QueryDisplayTimeout: Integer;
begin
  Result := DefaultInterface.QueryDisplayTimeout;
end;

function TMercuryFPrtCOM.QueryPrinterContrast: Integer;
begin
  Result := DefaultInterface.QueryPrinterContrast;
end;

function TMercuryFPrtCOM.QueryLeading: Integer;
begin
  Result := DefaultInterface.QueryLeading;
end;

procedure TMercuryFPrtCOM.EnableGraphicHeader(Width: Integer; Height: Integer; 
                                              const Data: WideString);
begin
  DefaultInterface.EnableGraphicHeader(Width, Height, Data);
end;

procedure TMercuryFPrtCOM.DisableGraphicHeader;
begin
  DefaultInterface.DisableGraphicHeader;
end;

procedure TMercuryFPrtCOM.AddLicence(LicType: TxMercLicenceType; const Licence: WideString);
begin
  DefaultInterface.AddLicence(LicType, Licence);
end;

function TMercuryFPrtCOM.XReport(Flags: Integer): Integer;
begin
  Result := DefaultInterface.XReport(Flags);
end;

function TMercuryFPrtCOM.XReportByDep(DepartNum: Integer; Flags: Integer): Integer;
begin
  Result := DefaultInterface.XReportByDep(DepartNum, Flags);
end;

function TMercuryFPrtCOM.XReportByOper(OperNum: Integer; Flags: Integer): Integer;
begin
  Result := DefaultInterface.XReportByOper(OperNum, Flags);
end;

function TMercuryFPrtCOM.QueryHeaderAlignment: WordBool;
begin
  Result := DefaultInterface.QueryHeaderAlignment;
end;

function TMercuryFPrtCOM.QueryOperNumber: Integer;
begin
  Result := DefaultInterface.QueryOperNumber;
end;

function TMercuryFPrtCOM.QueryOperName(OperNum: Integer): WideString;
begin
  Result := DefaultInterface.QueryOperName(OperNum);
end;

procedure TMercuryFPrtCOM.SetHeaderAlignment(Aligned: WordBool);
begin
  DefaultInterface.SetHeaderAlignment(Aligned);
end;

procedure TMercuryFPrtCOM.TestConnection;
begin
  DefaultInterface.TestConnection;
end;

function TMercuryFPrtCOM.QueryAutocut: WordBool;
begin
  Result := DefaultInterface.QueryAutocut;
end;

procedure TMercuryFPrtCOM.SetAutocut(Autocut: WordBool);
begin
  DefaultInterface.SetAutocut(Autocut);
end;

function TMercuryFPrtCOM.QueryEconomicMode: WordBool;
begin
  Result := DefaultInterface.QueryEconomicMode;
end;

procedure TMercuryFPrtCOM.SetEconomicMode(EconomicMode: WordBool);
begin
  DefaultInterface.SetEconomicMode(EconomicMode);
end;

procedure TMercuryFPrtCOM.EKLZActivate;
begin
  DefaultInterface.EKLZActivate;
end;

procedure TMercuryFPrtCOM.EKLZActivationReport;
begin
  DefaultInterface.EKLZActivationReport;
end;

procedure TMercuryFPrtCOM.EKLZDayReport(DayNumber: Integer);
begin
  DefaultInterface.EKLZDayReport(DayNumber);
end;

procedure TMercuryFPrtCOM.EKLZReportByNum(IsFull: WordBool; AStartNum: Integer; AEndNum: Integer);
begin
  DefaultInterface.EKLZReportByNum(IsFull, AStartNum, AEndNum);
end;

procedure TMercuryFPrtCOM.EKLZReportByDate(IsFull: WordBool; AStartDate: TDateTime; 
                                           AEndDate: TDateTime);
begin
  DefaultInterface.EKLZReportByDate(IsFull, AStartDate, AEndDate);
end;

procedure TMercuryFPrtCOM.EKLZDocByNum(Number: Integer);
begin
  DefaultInterface.EKLZDocByNum(Number);
end;

procedure TMercuryFPrtCOM.EKLZControlByNum(DayNumber: Integer);
begin
  DefaultInterface.EKLZControlByNum(DayNumber);
end;

procedure TMercuryFPrtCOM.EKLZCloseArchive;
begin
  DefaultInterface.EKLZCloseArchive;
end;

procedure TMercuryFPrtCOM.EKLZQueryStatus;
begin
  DefaultInterface.EKLZQueryStatus;
end;

function TMercuryFPrtCOM.QueryPaperJournal: WordBool;
begin
  Result := DefaultInterface.QueryPaperJournal;
end;

procedure TMercuryFPrtCOM.SetPaperJournal(PaperJournal: WordBool);
begin
  DefaultInterface.SetPaperJournal(PaperJournal);
end;

function TMercuryFPrtCOM.QueryFullJournal: WordBool;
begin
  Result := DefaultInterface.QueryFullJournal;
end;

procedure TMercuryFPrtCOM.SetFullJournal(FullJournal: WordBool);
begin
  DefaultInterface.SetFullJournal(FullJournal);
end;

procedure TMercuryFPrtCOM.AddEKLZData(Flags: Integer; HOffset: Integer; VOffset: Integer);
begin
  DefaultInterface.AddEKLZData(Flags, HOffset, VOffset);
end;

procedure TMercuryFPrtCOM.AddRegNumber(Flags: Integer; HOffset: Integer; VOffset: Integer);
begin
  DefaultInterface.AddRegNumber(Flags, HOffset, VOffset);
end;

procedure TMercuryFPrtCOM.WriteGraphic(Number: Integer; Width: Integer; Height: Integer; 
                                       const Data: WideString);
begin
  DefaultInterface.WriteGraphic(Number, Width, Height, Data);
end;

procedure TMercuryFPrtCOM.PrintGraphic(Width: Integer; Height: Integer; const Data: WideString);
begin
  DefaultInterface.PrintGraphic(Width, Height, Data);
end;

function TMercuryFPrtCOM.QueryParameterBool(ParamCode: Integer): WordBool;
begin
  Result := DefaultInterface.QueryParameterBool(ParamCode);
end;

function TMercuryFPrtCOM.QueryParameterInt(ParamCode: Integer): Integer;
begin
  Result := DefaultInterface.QueryParameterInt(ParamCode);
end;

procedure TMercuryFPrtCOM.SetParameterBool(ParamCode: Integer; ParamValue: WordBool);
begin
  DefaultInterface.SetParameterBool(ParamCode, ParamValue);
end;

procedure TMercuryFPrtCOM.SetParameterInt(ParamCode: Integer; ParamValue: Integer);
begin
  DefaultInterface.SetParameterInt(ParamCode, ParamValue);
end;

procedure TMercuryFPrtCOM.PrintHeader;
begin
  DefaultInterface.PrintHeader;
end;

procedure TMercuryFPrtCOM.SetOperPassword(OperNum: Integer; const OperName: WideString; 
                                          const OperPassword: WideString);
begin
  DefaultInterface.SetOperPassword(OperNum, OperName, OperPassword);
end;

function TMercuryFPrtCOM.PrintEKL(Flags: Integer): Integer;
begin
  Result := DefaultInterface.PrintEKL(Flags);
end;

function TMercuryFPrtCOM.QueryEKLState: TxMercEKLState;
begin
  Result := DefaultInterface.QueryEKLState;
end;

procedure TMercuryFPrtCOM.ReprintDocument;
begin
  DefaultInterface.ReprintDocument;
end;

{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
constructor TMercuryFPrtCOMProperties.Create(AServer: TMercuryFPrtCOM);
begin
  inherited Create;
  FServer := AServer;
end;

function TMercuryFPrtCOMProperties.GetDefaultInterface: IMercuryFPrt10;
begin
  Result := FServer.DefaultInterface;
end;

function TMercuryFPrtCOMProperties.Get_EcrModel: TxMercEcrModel;
begin
    Result := DefaultInterface.EcrModel;
end;

function TMercuryFPrtCOMProperties.Get_EcrVersion: Integer;
begin
    Result := DefaultInterface.EcrVersion;
end;

function TMercuryFPrtCOMProperties.Get_Generation: Integer;
begin
    Result := DefaultInterface.Generation;
end;

function TMercuryFPrtCOMProperties.Get_Protocol: TxMercProtocol;
begin
    Result := DefaultInterface.Protocol;
end;

function TMercuryFPrtCOMProperties.Get_EcrStatus: Integer;
begin
    Result := DefaultInterface.EcrStatus;
end;

function TMercuryFPrtCOMProperties.Get_EcrStatusMask: Integer;
begin
    Result := DefaultInterface.EcrStatusMask;
end;

function TMercuryFPrtCOMProperties.Get_DevStatus: Integer;
begin
    Result := DefaultInterface.DevStatus;
end;

function TMercuryFPrtCOMProperties.Get_DevStatusMask: Integer;
begin
    Result := DefaultInterface.DevStatusMask;
end;

function TMercuryFPrtCOMProperties.Get_DocStatus: TxMercDocStatus;
begin
    Result := DefaultInterface.DocStatus;
end;

function TMercuryFPrtCOMProperties.Get_CurrentOper: TxMercOperType;
begin
    Result := DefaultInterface.CurrentOper;
end;

function TMercuryFPrtCOMProperties.Get_PortNum: Integer;
begin
    Result := DefaultInterface.PortNum;
end;

procedure TMercuryFPrtCOMProperties.Set_PortNum(Value: Integer);
begin
  DefaultInterface.Set_PortNum(Value);
end;

function TMercuryFPrtCOMProperties.Get_BaudRate: Integer;
begin
    Result := DefaultInterface.BaudRate;
end;

procedure TMercuryFPrtCOMProperties.Set_BaudRate(Value: Integer);
begin
  DefaultInterface.Set_BaudRate(Value);
end;

function TMercuryFPrtCOMProperties.Get_Password: WideString;
begin
    Result := DefaultInterface.Password;
end;

procedure TMercuryFPrtCOMProperties.Set_Password(const Value: WideString);
  { Warning: The property Password has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TMercuryFPrtCOMProperties.Get_InternalTimeout: Integer;
begin
    Result := DefaultInterface.InternalTimeout;
end;

procedure TMercuryFPrtCOMProperties.Set_InternalTimeout(Value: Integer);
begin
  DefaultInterface.Set_InternalTimeout(Value);
end;

function TMercuryFPrtCOMProperties.Get_ExternalTimeout: Integer;
begin
    Result := DefaultInterface.ExternalTimeout;
end;

procedure TMercuryFPrtCOMProperties.Set_ExternalTimeout(Value: Integer);
begin
  DefaultInterface.Set_ExternalTimeout(Value);
end;

function TMercuryFPrtCOMProperties.Get_Active: WordBool;
begin
    Result := DefaultInterface.Active;
end;

procedure TMercuryFPrtCOMProperties.Set_Active(Value: WordBool);
begin
  DefaultInterface.Set_Active(Value);
end;

function TMercuryFPrtCOMProperties.Get_ConnState: TxMercConnState;
begin
    Result := DefaultInterface.ConnState;
end;

function TMercuryFPrtCOMProperties.Get_SaleSum: Currency;
begin
    Result := DefaultInterface.SaleSum;
end;

function TMercuryFPrtCOMProperties.Get_BuyingSum: Currency;
begin
    Result := DefaultInterface.BuyingSum;
end;

function TMercuryFPrtCOMProperties.Get_SerialNumber: WideString;
begin
    Result := DefaultInterface.SerialNumber;
end;

function TMercuryFPrtCOMProperties.Get_RegNumber: WideString;
begin
    Result := DefaultInterface.RegNumber;
end;

function TMercuryFPrtCOMProperties.Get_TaxPayerNumber: WideString;
begin
    Result := DefaultInterface.TaxPayerNumber;
end;

function TMercuryFPrtCOMProperties.Get_HeaderLine1: WideString;
begin
    Result := DefaultInterface.HeaderLine1;
end;

function TMercuryFPrtCOMProperties.Get_HeaderLine2: WideString;
begin
    Result := DefaultInterface.HeaderLine2;
end;

function TMercuryFPrtCOMProperties.Get_HeaderLine3: WideString;
begin
    Result := DefaultInterface.HeaderLine3;
end;

function TMercuryFPrtCOMProperties.Get_HeaderLine4: WideString;
begin
    Result := DefaultInterface.HeaderLine4;
end;

function TMercuryFPrtCOMProperties.Get_StartDate: TDateTime;
begin
    Result := DefaultInterface.StartDate;
end;

function TMercuryFPrtCOMProperties.Get_EndDate: TDateTime;
begin
    Result := DefaultInterface.EndDate;
end;

function TMercuryFPrtCOMProperties.Get_StartNumber: Integer;
begin
    Result := DefaultInterface.StartNumber;
end;

function TMercuryFPrtCOMProperties.Get_EndNumber: Integer;
begin
    Result := DefaultInterface.EndNumber;
end;

function TMercuryFPrtCOMProperties.Get_ReportDate: TDateTime;
begin
    Result := DefaultInterface.ReportDate;
end;

function TMercuryFPrtCOMProperties.Get_ModelName: WideString;
begin
    Result := DefaultInterface.ModelName;
end;

function TMercuryFPrtCOMProperties.Get_Manufacturer: WideString;
begin
    Result := DefaultInterface.Manufacturer;
end;

function TMercuryFPrtCOMProperties.Get_FirmwareVersion: WideString;
begin
    Result := DefaultInterface.FirmwareVersion;
end;

function TMercuryFPrtCOMProperties.Get_TaxName: WideString;
begin
    Result := DefaultInterface.TaxName;
end;

function TMercuryFPrtCOMProperties.Get_TaxDate: TDateTime;
begin
    Result := DefaultInterface.TaxDate;
end;

function TMercuryFPrtCOMProperties.Get_CounterCount: Integer;
begin
    Result := DefaultInterface.CounterCount;
end;

function TMercuryFPrtCOMProperties.Get_RewritesRemain: Integer;
begin
    Result := DefaultInterface.RewritesRemain;
end;

function TMercuryFPrtCOMProperties.Get_DaysRemain: Integer;
begin
    Result := DefaultInterface.DaysRemain;
end;

function TMercuryFPrtCOMProperties.Get_LastFiscalReport: Integer;
begin
    Result := DefaultInterface.LastFiscalReport;
end;

function TMercuryFPrtCOMProperties.Get_LastDayClosing: Integer;
begin
    Result := DefaultInterface.LastDayClosing;
end;

function TMercuryFPrtCOMProperties.Get_DayDate: TDateTime;
begin
    Result := DefaultInterface.DayDate;
end;

function TMercuryFPrtCOMProperties.Get_LastDocOper: TxMercOperType;
begin
    Result := DefaultInterface.LastDocOper;
end;

function TMercuryFPrtCOMProperties.Get_LastDocNumber: Integer;
begin
    Result := DefaultInterface.LastDocNumber;
end;

function TMercuryFPrtCOMProperties.Get_LastRecNumber: Integer;
begin
    Result := DefaultInterface.LastRecNumber;
end;

function TMercuryFPrtCOMProperties.Get_LastDocType: TxMercOperType;
begin
    Result := DefaultInterface.LastDocType;
end;

function TMercuryFPrtCOMProperties.Get_LastDocSum: Currency;
begin
    Result := DefaultInterface.LastDocSum;
end;

function TMercuryFPrtCOMProperties.Get_LastDocDate: TDateTime;
begin
    Result := DefaultInterface.LastDocDate;
end;

function TMercuryFPrtCOMProperties.Get_RetryOperation: WordBool;
begin
    Result := DefaultInterface.RetryOperation;
end;

procedure TMercuryFPrtCOMProperties.Set_RetryOperation(Value: WordBool);
begin
  DefaultInterface.Set_RetryOperation(Value);
end;

function TMercuryFPrtCOMProperties.Get_ErrCode: Integer;
begin
    Result := DefaultInterface.ErrCode;
end;

function TMercuryFPrtCOMProperties.Get_ErrCodeEx: Integer;
begin
    Result := DefaultInterface.ErrCodeEx;
end;

function TMercuryFPrtCOMProperties.Get_ErrMessage: WideString;
begin
    Result := DefaultInterface.ErrMessage;
end;

function TMercuryFPrtCOMProperties.Get_EcrHour: Integer;
begin
    Result := DefaultInterface.EcrHour;
end;

function TMercuryFPrtCOMProperties.Get_EcrMin: Integer;
begin
    Result := DefaultInterface.EcrMin;
end;

function TMercuryFPrtCOMProperties.Get_ReportHour: Integer;
begin
    Result := DefaultInterface.ReportHour;
end;

function TMercuryFPrtCOMProperties.Get_ReportMin: Integer;
begin
    Result := DefaultInterface.ReportMin;
end;

function TMercuryFPrtCOMProperties.Get_DayHour: Integer;
begin
    Result := DefaultInterface.DayHour;
end;

function TMercuryFPrtCOMProperties.Get_DayMin: Integer;
begin
    Result := DefaultInterface.DayMin;
end;

function TMercuryFPrtCOMProperties.Get_LastDocHour: Integer;
begin
    Result := DefaultInterface.LastDocHour;
end;

function TMercuryFPrtCOMProperties.Get_LastDocMin: Integer;
begin
    Result := DefaultInterface.LastDocMin;
end;

function TMercuryFPrtCOMProperties.Get_VersionNumber: Integer;
begin
    Result := DefaultInterface.VersionNumber;
end;

function TMercuryFPrtCOMProperties.Get_BuildNumber: Integer;
begin
    Result := DefaultInterface.BuildNumber;
end;

function TMercuryFPrtCOMProperties.Get_Version: WideString;
begin
    Result := DefaultInterface.Version;
end;

procedure TMercuryFPrtCOMProperties.Set_Version(const Value: WideString);
  { Warning: The property Version has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TMercuryFPrtCOMProperties.Get_EcrSubVersion: Integer;
begin
    Result := DefaultInterface.EcrSubVersion;
end;

function TMercuryFPrtCOMProperties.Get_EKLZSupported: WordBool;
begin
    Result := DefaultInterface.EKLZSupported;
end;

function TMercuryFPrtCOMProperties.Get_EKLZActivated: WordBool;
begin
    Result := DefaultInterface.EKLZActivated;
end;

function TMercuryFPrtCOMProperties.Get_EKLZOper: TxMercOperType;
begin
    Result := DefaultInterface.EKLZOper;
end;

function TMercuryFPrtCOMProperties.Get_EKLZArchiving: WordBool;
begin
    Result := DefaultInterface.EKLZArchiving;
end;

function TMercuryFPrtCOMProperties.Get_EKLZReporting: WordBool;
begin
    Result := DefaultInterface.EKLZReporting;
end;

function TMercuryFPrtCOMProperties.Get_EKLZDayOpened: WordBool;
begin
    Result := DefaultInterface.EKLZDayOpened;
end;

function TMercuryFPrtCOMProperties.Get_EKLZFatalError: WordBool;
begin
    Result := DefaultInterface.EKLZFatalError;
end;

function TMercuryFPrtCOMProperties.Get_EKLZAttention: WordBool;
begin
    Result := DefaultInterface.EKLZAttention;
end;

function TMercuryFPrtCOMProperties.Get_LastRepNumber: Integer;
begin
    Result := DefaultInterface.LastRepNumber;
end;

function TMercuryFPrtCOMProperties.Get_EKLZRest: Integer;
begin
    Result := DefaultInterface.EKLZRest;
end;

function TMercuryFPrtCOMProperties.Get_LastBuyingSum: Currency;
begin
    Result := DefaultInterface.LastBuyingSum;
end;
...
begin
  ...
  RegisterComponents(dtlServerPage, [TMercuryFPrtCOM]);
end;
