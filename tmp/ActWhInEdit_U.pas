...
procedure TActWhInEdit_F.Bt_SaveClick(Sender: TObject);
var
 pms:TMemoryStream;
 id_rec:Integer;
begin
...
procedure TActWhInEdit_F.E_SVhNumbersChange(Sender: TObject);
begin
 ChangePlaceFlag:=True;
end;

procedure TActWhInEdit_F.E_SVhNumbersRightButtonClick(Sender: TObject);
begin
...
procedure TActWhInEdit_F.E_WeightDocChange(Sender: TObject);
var
i : integer;
c : char;
s : string;
...
procedure TActWhInEdit_F.E_WeightFactChange(Sender: TObject);
var
i : integer;
c : char;
s : string;
...
procedure TActWhInEdit_F.FormShow(Sender: TObject);
begin
 ChangePlaceFlag:=false;
 GetValues;
end;

procedure TActWhInEdit_F.GetValues;
begin
