...
// $Rev: 98336 $
// File generated on 19.08.2022 17:19:56 from Type Library described below.
...
// *********************************************************************//
  IATOL_OPOSEvents = dispinterface
    ...
    function DirectIOEvent(EventNumber: Integer; var pData: Integer; var pString: WideString): HResult; dispid 2;
    function ErrorEvent(ResultCode: Integer; ResultCodeExtended: Integer; ErrorLocus: Integer; 
                        var pErrorResponse: Integer): HResult; dispid 3;
    function OutputCompleteEvent(OutputID: Integer): HResult; dispid 4;
    function StatusUpdateEvent(Data: Integer): HResult; dispid 5;
  end;
