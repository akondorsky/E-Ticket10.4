object OutdocEdit_F: TOutdocEdit_F
  Left = 460
  Top = 172
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = #1056#1072#1079#1088#1077#1096#1080#1090#1077#1083#1100#1085#1099#1081' '#1076#1086#1082#1091#1084#1077#1085#1090'.'#1056#1077#1076#1072#1082#1090#1080#1088#1086#1074#1072#1085#1080#1077
  ClientHeight = 174
  ClientWidth = 428
  Color = clBtnFace
  ...
  object GroupBox1: TGroupBox
    ...
    object E_Dgtd: TDateTimePicker
      ...
      Width = 97
      Height = 21
      Date = 41337.816465590280000000
      Time = 41337.816465590280000000
      TabOrder = 3
    end
  end
