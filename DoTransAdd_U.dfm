object DoTransAdd_F: TDoTransAdd_F
  Left = 470
  Top = 207
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = #1058#1088#1072#1085#1089#1087#1086#1088#1090#1085#1099#1077' '#1089#1088#1077#1076#1089#1090#1074#1072'.'#1044#1086#1073#1072#1074#1083#1077#1085#1080#1077
  ClientHeight = 119
  ClientWidth = 431
  Color = clBtnFace
