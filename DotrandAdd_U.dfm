object DotrandAdd_F: TDotrandAdd_F
  Left = 470
  Top = 207
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = #1058#1088#1072#1085#1089#1087#1086#1088#1090#1085#1099#1077' '#1076#1086#1082#1091#1084#1077#1085#1090#1099'.'#1044#1086#1073#1072#1074#1083#1077#1085#1080#1077
  ClientHeight = 171
  ClientWidth = 431
  Color = clBtnFace
